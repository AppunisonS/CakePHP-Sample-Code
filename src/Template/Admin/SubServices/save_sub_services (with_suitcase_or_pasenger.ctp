        ...
        <div class="col-md-12 centered">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <!-----------------passengers Checkbox Start---------------------------->

                    <div class="box-body" id="passenger">
                        <div class="row form-group col-md-12">
                            <div class="col-xs-2">
                                <?php echo $this->Form->checkbox('passengers[type]', array(isset($this->request->data['passengers']['type']) ? 'checked' : '', 'value' => 'passengers', 'id' => 'passengerschek')); ?>&nbsp;&nbsp;&nbsp; &nbsp; Passengers
                                <?php
                                if (isset($id) && !empty($id)) {
                                    echo $this->Form->hidden('passengers[id]', array('value' => isset($this->request->data['passengers']['id']) ? $this->request->data['passengers']['id'] : '', 'id' => 'passengers'));
                                }
                                ?>
                            </div>
                            <div class="col-xs-2">
                                <?php echo $this->Form->input('passengers[unit]', array('value' => isset($this->request->data['passengers']['unit']) ? $this->request->data['passengers']['unit'] : '', 'id' => 'passengersList', 'class' => 'form-control', 'label' => false, 'placeholder' => 'passengers')); ?>
                            </div>
                            <div class="col-xs-2">
                                <?php echo $this->Form->input('passengers[price]', array('value' => isset($this->request->data['passengers']['price']) ? $this->request->data['passengers']['price'] : '', 'id' => 'passengersPrice', 'class' => 'form-control', 'label' => false, 'placeholder' => 'Base Price')); ?>
                            </div>
                            <div class="col-xs-2">
                                <?php echo $this->Form->input('passengers[xetra_unit]', array('value' => isset($this->request->data['passengers']['xetra_unit']) ? $this->request->data['passengers']['xetra_unit'] : '', 'id' => 'passengersXetraList', 'class' => 'form-control', 'label' => false, 'placeholder' => 'Xetra passengers')); ?>
                            </div>
                            <div class="col-xs-2">
                                <?php echo $this->Form->input('passengers[xetra_price]', array('value' => isset($this->request->data['passengers']['xetra_price']) ? $this->request->data['passengers']['xetra_price'] : '', 'id' => 'passengersXetraPrice', 'class' => 'form-control', 'label' => false, 'placeholder' => 'Xetra Price')); ?>
                            </div>
                        </div>
                    </div>
                    <!-----------------passengers Checkbox End---------------------------->


                    <!-----------------suitcases Checkbox Start---------------------------->

                    <div class="box-body" id="suitcase">
                        <div class="row form-group col-md-12">
                            <div class="col-xs-2">
                                <?php echo $this->Form->checkbox('suitcases[type]', array(isset($this->request->data['suitcases']['type']) ? 'checked' : '', 'value' => 'suitcases', 'id' => 'suitcaseschek')); ?>&nbsp;&nbsp;&nbsp; &nbsp; Suitcases
                                <?php
                                if (isset($id) && !empty($id)) {
                                    echo $this->Form->hidden('suitcases[id]', array('value' => isset($this->request->data['suitcases']['id']) ? $this->request->data['suitcases']['id'] : '', 'id' => 'suitcases'));
                                }
                                ?>
                            </div>
                            <div class="col-xs-2">
                                <?php echo $this->Form->input('suitcases[unit]', array('value' => isset($this->request->data['suitcases']['unit']) ? $this->request->data['suitcases']['unit'] : '', 'id' => 'suitcasesUnit', 'class' => 'form-control', 'label' => false, 'placeholder' => 'Suitcases')); ?>
                            </div>
                            <div class="col-xs-2">
                                <?php echo $this->Form->input('suitcases[price]', array('value' => isset($this->request->data['suitcases']['price']) ? $this->request->data['suitcases']['price'] : '', 'id' => 'suitcasesPrice', 'class' => 'form-control', 'label' => false, 'placeholder' => 'Base Price')); ?>
                            </div>
                            <div class="col-xs-2">
                                <?php echo $this->Form->input('suitcases[xetra_unit]', array('value' => isset($this->request->data['suitcases']['xetra_unit']) ? $this->request->data['suitcases']['xetra_unit'] : '', 'id' => 'suitcasesXetraUnit', 'class' => 'form-control', 'label' => false, 'placeholder' => 'Xetra Suitcases')); ?>
                            </div>
                            <div class="col-xs-2">
                                <?php echo $this->Form->input('suitcases[xetra_price]', array('value' => isset($this->request->data['suitcases']['xetra_price']) ? $this->request->data['suitcases']['xetra_price'] : '', 'id' => 'suitcasesXetraPrice', 'class' => 'form-control', 'label' => false, 'placeholder' => 'Xetra Price')); ?>
                            </div>
                        </div>
                    </div>
                    <!-----------------suitcases Checkbox End---------------------------->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#bedroomchek').click(function () {
            ...
            $('#suitcaseschek').removeAttr('checked');
            $('#suitcasesUnit').hide();
            $('#suitcasesPrice').hide();
            $('#suitcasesXetraUnit').hide();
            $('#suitcasesXetraPrice').hide();

            $('#passengerschek').removeAttr('checked');
            $('#passengersList').hide();
            $('#passengersPrice').hide();
            $('#passengersXetraList').hide();
            $('#passengersXetraPrice').hide();
...
<?php } ?>
        ...
        $('#passengerschek').click(function () {
            $('#passengersList').toggle();
            $('#passengersPrice').toggle();
            $('#passengersXetraList').toggle();
            $('#passengersXetraPrice').toggle();
...
<?php } ?>
        ...
        $('#suitcaseschek').click(function () {
            $('#suitcasesUnit').toggle();
            $('#suitcasesPrice').toggle();
            $('#suitcasesXetraUnit').toggle();
            $('#suitcasesXetraPrice').toggle();
...
<?php if (!empty($id)) { ?>
            ...
            if ($("#passengerschek").prop('checked') == true) {
                $('#passengersList').show();
                $('#passengersPrice').show();
                $('#passengersXetraList').show();
                $('#passengersXetraPrice').show();
            }

            if ($("#suitcaseschek").prop('checked') == true) {
                $('#suitcasesUnit').show();
                $('#suitcasesPrice').show();
                $('#suitcasesXetraUnit').show();
                $('#suitcasesXetraPrice').show();
            }
...
<style>
    ...
    ,#suitcasesXetraPrice,#suitcasesXetraUnit,#suitcasesPrice,#suitcasesUnit
    ,#bedroomXetraTime,#bedroomDefultTime,#bathroomXetraTime,#bathroomDefultTime
    ,#passengersList,#passengersPrice,#passengersXetraList,#passengersXetraPrice{
        display:none;
    }
</style>
